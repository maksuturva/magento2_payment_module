...
class Success extends \Svea\MaksuturvaMasterpass\Controller\AbstractController
{
    public function execute()
    {
        ...
        if ($pmt_paymentmethod != \Svea\MaksuturvaMasterpass\Model\Masterpass::MAKSUTURVA_MASTERPASS_METHOD_CODE) {
        ...
        if ($responseXml->pmtq_paymentmethod != \Svea\MaksuturvaMasterpass\Model\Masterpass::MAKSUTURVA_MASTERPASS_METHOD_CODE) {
            $this->_redirect('masterpass/authorize/error');
            return false;
        }
