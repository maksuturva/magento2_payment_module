<?php
namespace Piimega\MaksuturvaPartPayment\Block\Form;
class PartPayment extends \Piimega\Maksuturva\Block\Form\Maksuturva
{
		...
		if ($preselect) {
			switch ($this->getFormType()) {
				case self::FORMTYPE_DROPDOWN:
					$this->setTemplate('Piimega_MaksuturvaPartPayment::form_select.phtml');
					break;
				case self::FORMTYPE_ICONS:
					$this->setTemplate('Piimega_MaksuturvaPartPayment::form_icons.phtml');
					break;
				default:
					throw new Exception('unknown form type');
			}
		}else{
			$this->setTemplate('Piimega_MaksuturvaPartPayment::icon.phtml');
		}
