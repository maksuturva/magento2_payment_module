    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        if(isset($fieldConfig['id']) && $fieldConfig['id']=="manually_query_in_hour"){
            ...
            $html = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')
                ->setData(
                    [
                        'label' => __('Manually Query Svea Payments API For Orders Created In Past 24 Hours'),
            ...
            $html = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')
                ->setData(
                    [
                        'label' => __('Manually Query Svea Payments API For Orders Created In Past Week'),
                        'onclick' => "setLocation('$url')",
                        'class' => 'action-add',
                    ]
                )->toHtml();
